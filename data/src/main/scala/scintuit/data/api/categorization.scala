...
object categorization {
  ...
  sealed abstract class ConsumerCategory(val code: String, val name: String) extends EnumEntry {
  ...
  sealed abstract class ConsumerSubcategory(code: String, name: String, override val group: ConsumerCategory) extends ConsumerCategory(code, name)

  object ConsumerCategory extends Enum[ConsumerCategory] {
    val values = findValues

    def withCodeOption(code: String): Option[ConsumerCategory] = values.find(_.code == code)
